...
<acme:form readonly="true">
	...
	<acme:input-textbox code="teacher.helpRequest.form.label.learner" path="learner.username"/>	
	<acme:input-textbox code="teacher.helpRequest.form.label.tutorial" path="tutorial.id"/>	
</acme:form>